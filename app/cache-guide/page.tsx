...
export default async function CacheGuidePage() {
  const user = await requireUser();
  const themePreference = await getUiThemePreference();

  return (
    <div className="shell" data-theme={themePreference.theme}>
      <AppNav user={user} themeMode={themePreference.mode} />
      <main className="main cache-guide">
        <section className="panel">
          <div className="panel-header">
            <h1 className="panel-title">Cloudflare 缓存规则配置说明</h1>
